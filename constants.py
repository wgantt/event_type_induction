...
PREDICATE_ANNOTATION_ATTRIBUTES = {'time': {'duration': {'type': NOMINAL, 'dim': 10}},
								   ...
								   'event_structure': {'natural_parts': {'type': BINARY, 'dim': 1},
...
ARGUMENT_ANNOTATION_ATTRIBUTES = {'genericity': {'arg-abstract': {'type': BINARY, 'dim': 1},
												 'arg-kind': {'type': BINARY, 'dim': 1},
												 'arg-particular': {'type': BINARY, 'dim': 1}},
								  'wordsense': {'supersense-noun.shape': {'type': BINARY, 'dim': 1},
...
SEMANTICS_EDGE_ANNOTATION_ATTRIBUTES = {'protoroles': {'was_used': {'type': BINARY, 'dim': 1},
...
DOCUMENT_EDGE_ANNOTATION_ATTRIBUTES = {'mereology': {'containment': {'type': BINARY, 'dim': 1}},
